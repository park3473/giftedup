...
<body>
    ...
    <div class="sub_cont_wrap">
     ...
     <!-- 타이틀 -->
        <div class="font_noto all_tit_30">${model.view.title }</div>
        <div class="t_pad_15">
                            ...
                            <div class="sub_page">
                                <div class="list_wrap">
                                    ...
                                    <input type="hidden" name="name" value="${ssion_name }">
                                   	<div id="respondents" class="member_input_wrap">
                                        ...
                                        <ul class="member_input nanumgothic">
                                        	...
                                        	<c:forEach var="fileCnt" begin="1" end="${model.view.file_cnt }">
                                        	<li class="pd-lr-10">
                                    ...
                                    <div class="board_btn_wrap">
                                  		<div class="board_btn">
                                  			<a class="stat_update" href="#" onclick="submission()">제출하기</a>
                                  		</div>
                                  	</div>
                                </div>
                            </div>
