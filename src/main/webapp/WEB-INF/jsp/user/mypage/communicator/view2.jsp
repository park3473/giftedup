                            ...
                            <div class="sub_page">
                                ...
                                <div class="member_input_wrap" id="member_input_wrap">
                                    <form action="/user/mypage/communicator/insert.do" method="post" name="insertform" id="insertform" enctype="multipart/form-data">
                                        ...
                                        <ul class="member_input nanumgothic">
                                            ...
                                            <c:if test="${model.View.COMM_STAT == '2' || model.View.COMM_STAT == '3' || model.View.COMM_STAT == '4' }">
                                            <c:if test="${ssion_member_type == '2' }">
                                            <li class="pd-lr-10" style="padding-bottom:10px;">
                                                <span class="list_t">ZOOM - ID<b class="relate_c">＊</b></span>
                                                <input id="ZOOM_ID" name="ZOOM_ID" readonly="readonly" value="">
                                            </li>
                                            <li class="pd-lr-10" style="padding-bottom:10px;">
                                                <span class="list_t">ZOOM - PW<b class="relate_c">＊</b></span>
                                                <input id="ZOOM_PW" name="ZOOM_PW" readonly="readonly" value="">
                                            </li>
                                            <li class="pd-lr-10" style="padding-bottom:10px;">
                                                <span class="list_t">ZOOM - EMAIL<b class="relate_c">＊</b></span>
                                                <input style="width:300px" id="ZOOM_EMAIL" name="ZOOM_EMAIL" readonly="readonly" value="">
                                            </li>
                                            </c:if>
                                            <li class="pd-lr-10" style="padding-bottom:10px;">
                                                <span class="list_t">ZOOM - 번호<b class="relate_c">＊</b></span>
                                                <input style="width:300px" id="ZOOM_MT_ID" name="ZOOM_MT_ID" readonly="readonly" value="">
                                            </li> 
                                            <li class="pd-lr-10" style="padding-bottom:10px;">
                                                <span class="list_t">ZOOM - 비밀번호<b class="relate_c">＊</b></span>
                                                <input id="ZOOM_MT_PW" name="ZOOM_MT_PW" readonly="readonly" value="">
                                            </li>
                                            <c:if test="${model.View.COMM_STAT == '3' || model.View.COMM_STAT == '4' }">
                                            <li class="pd-lr-10" style="padding-bottom:10px;">
                                                <span class="list_t">ZOOM - 링크</span>
                                                <input style="width:80%" onclick="" id="ZOOM_LINK" name="ZOOM_LINK" readonly="readonly" value="">
                                            </li>  
                                            </c:if>
                                            </c:if>
                                            <li class="pd-lr-10">
                                ...
                                <div class="board_btn_wrap">
                                    <div class="board_btn">
                                        ...
                                        <a class="stat_update" href="javascript:comm_student_check(${model.View.COMM_IDX })">접수 마감</a>
...
<script type="text/javascript">
	...
	function PrintDiv(div){
		...
		html2canvas(div).then(function(canvas){
			...
			*/
			...
			//포트폴리오 이동코드
			popup = window.open("/user/portfolio/detail/${ssion_user_id}/insert.do?YEAR=2021");
    ...
    function comm_apply_end(){
    	...
    	if(confirm('정말 접수를 마감하시겠습니까?\n강의 접수를 마감시 더이상 추가 접수가 불가능합니다.')){
    		location.href = '${pageContext.request.contextPath}/user/mypage/communicator/CommApplyEnd.do?COMM_IDX=${model.View.COMM_IDX}&COMM_STAT=2&ZOOM_MEMBER_ID='+ZOOM_MEMBER_ID+'&ZOOM_DT='+COMM_START_TM+'&ZOOM_ID='+ID+'&ZOOM_MT_ID='+MT_ID+'&ZOOM_MT_PW='+MT_PW+'&ZOOM_TYPE='+COMM_TIME+'';
    	}
    ...
    function comm_preparation(){
    	...
    	if(confirm('강의 준비를 시작하시겠습니까?\n강의 준비를 시작시 더이상 접수 마감상태로 되돌아갈수 없습니다.')){
    		location.href = '${pageContext.request.contextPath}/user/mypage/communicator/CommPreparation.do?COMM_IDX=${model.View.COMM_IDX}&COMM_STAT=3&ZOOM_ID='+ID+'&ZOOM_MT_ID='+MT_ID+'&ZOOM_MT_PW='+MT_PW+'';
    	}
    ...
    function comm_start(){
    	...
    	if(confirm('강의 진행을 시작하시겠습니까?')){
    		location.href = '${pageContext.request.contextPath}/user/mypage/communicator/CommStart.do?COMM_IDX=${model.View.COMM_IDX}&COMM_STAT=4&ZOOM_ID='+ID+'&ZOOM_MT_ID='+MT_ID+'&ZOOM_MT_PW='+MT_PW+'&ZOOM_DT='+ZOOM_DT+'&ZOOM_TYPE='+ZOOM_TYPE+'';
    	}
    }
	...
	$('#COMM_PERSONNEL_CHECK').click(function() {
		...
		$.ajax({
			...
			success : function(data, status, xhr) {
				...
				$('.student_check').find('.danger_modal_con').css('max-width','618px');
		        $('.danger_bg').show();
			},
			error : function(xhr, status, error) {
				if (xhr.status == 404) {
