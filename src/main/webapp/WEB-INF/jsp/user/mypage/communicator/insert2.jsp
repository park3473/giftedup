                                ...
                                <div class="member_input_wrap">
                                    <form action="" method="post" name="insertform" id="insertform" enctype="multipart/form-data">
                                        ...
                                        <ul class="member_input nanumgothic">
                                            ...
                                            <li class="pd-lr-10">
                                                <span class="list_t">이메일</span>
                                                <input class="input_size mr" type="text" name="COMM_LOCAL" id="COMM_LOCAL" value="${model.Mento.ADDRESS_LOCAL}" readonly="readonly">
                                            </li>
                                            <li class="pd-lr-10">
                                            ...
                                            <li class="pd-lr-10">
                                                <span class="list_t">대상학년<b class="relate_c">＊</b></span>
                                                	<table class="list_t_table">
                                                		<tr>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="4"><span>초등학교 4학년</span></td>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="5"><span>초등학교 5학년</span></td>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="6"><span>초등학교 6학년</span></td>
                                                		</tr>
                                                		<tr>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="7"><span>중학교 1학년</span></td>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="8"><span>중학교 2학년</span></td>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="9"><span>중학교 3학년</span></td>
                                                		</tr>
                                                		<tr>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="10"><span>고등학교 1학년</span></td>
                                                		</tr>
                                                	</table>
                                            ...
                                            <li class="pd-lr-10">
                                                ...
                                                <input class="input_size mr datecalendar" type="text" name="COMM_START_TM" id="COMM_START_TM">
                                                <span> ~ </span>
                                                <input class="input_size mr datecalendar" type="text" name="COMM_END_TM" id="COMM_END_TM">
                                                <input style="width:3.7rem" type="text" id="COMM_TIME" name="COMM_TIME" readonly="readonly" value="">
