                                            ...
                                            <li class="pd-lr-10">
                                                <span class="list_t">대상학년<b class="relate_c">＊</b></span>
                                                	<table class="list_t_table">
                                                		<tr>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="4" <c:if test="${fn:indexOf(model.View.COMM_SCHOOL_YEAR,'4') > -1 }"> checked="checked" </c:if> ><span>초등학교 4학년</span></td>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="5" <c:if test="${fn:indexOf(model.View.COMM_SCHOOL_YEAR,'5') > -1 } ">checked="checked"</c:if> ><span>초등학교 5학년</span></td>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="6" <c:if test="${fn:indexOf(model.View.COMM_SCHOOL_YEAR,'6') > -1 } ">checked="checked"</c:if> ><span>초등학교 6학년</span></td>
                                                		</tr>
                                                		<tr>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="7" <c:if test="${fn:indexOf(model.View.COMM_SCHOOL_YEAR,'7') > -1 }">checked="checked"</c:if> ><span>중학교 1학년</span></td>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="8" <c:if test="${fn:indexOf(model.View.COMM_SCHOOL_YEAR,'8') > -1 }">checked="checked"</c:if> ><span>중학교 2학년</span></td>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="9" <c:if test="${fn:indexOf(model.View.COMM_SCHOOL_YEAR,'9') > -1 }">checked="checked"</c:if> ><span>중학교 3학년</span></td>
                                                		</tr>
                                                		<tr>
                                                			<td><input class=" mr" type="checkbox" name="COMM_SCHOOL_YEAR_CHECK" id="COMM_SCHOOL_YEAR_CHECK" value="10" <c:if test="${fn:indexOf(model.View.COMM_SCHOOL_YEAR,'1') > -1 }">checked="checked"</c:if> ><span>고등학교 1학년</span></td>
                                                		</tr>
                                                	</table>
