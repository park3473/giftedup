                                ...
                                <div class="list_wrap">
                                    ...
                                    <div class="member_input_wrap">
                                        <ul class="member_input">
                                              <li>
                                                ...
                                                <input class="input_size" type="text" id="NAME" name="NAME" value="${model.pageDomain.NAME}">
                                                <label class="blind" for="NAME">성명</label>
                                            </li>
                                            <li>
                                                <span class="list_t">멘토링분야</span>
                                                <input class="input_size" type="text" id="TYPE" name="TYPE" value="${model.pageDomain.TYPE}">
                                                <label class="blind" for="TYPE">멘토링분야</label>
                                            </li>
                                            <li>
                                                <span class="list_t">소속</span>
                                                <input class="input_size" type="text" id="GROUP" name="GROUP" value="${model.pageDomain.GROUP}">
                                                <label class="blind" for="GROUP">소속</label>
                                            </li>
                                            <li>
                                                <span class="list_t">근무지 주소</span>
                                                <input class="input_address" type="text" id="ADDRESS" name="ADDRESS" value="${model.pageDomain.ADDRESS}">
                                                <label class="blind" for="ADDRESS">근무지 주소</label>
                                            </li>
                                            <li>
                                                <span class="list_t">지역</span>
                                                <input class="input_size" type="text" id="LOCATION" name="LOCATION" value="${model.pageDomain.LOCATION}">
                                                <label class="blind" for="LOCATION">지역</label>
                                            </li>
                                            <li>
                                                <span class="list_t">이메일</span>
                                                <input class="input_size" type="text" id="EMAIL" name="EMAIL" value="${model.pageDomain.EMAIL}">
                                                <label class="blind" for="EMAIL">이메일</label>
                                            </li>
                                            <li>
                                                <span class="list_t">연락처</span>
                                                <input class="input_size" type="text" id="PHONE" name="PHONE" value="${model.pageDomain.PHONE}">
                                                <label class="blind" for="PHONE">연락처</label>
                                            </li>
                                            <li>
                                                <span class="list_t">비고</span>
                                                <input class="input_size" type="text" id="MEMO" name="MEMO" value="${model.pageDomain.MEMO}">
                                    ...
                                    <div class="board_btn_wrap">
                                        <div class="board_btn">
                                            ...
                                            <a class="register" href="javascript:histoty.back()">취소하기</a>
                                        </div>
                                    </div>
                                    <!--보드 검색_버튼 end-->
