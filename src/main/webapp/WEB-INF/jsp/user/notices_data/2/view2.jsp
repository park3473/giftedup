                                ...
                                <div class="info_wrap">
                                    ...
                                    <table class="txt info_table">
                                        <tr>
                                            ...
                                            <td>${model.pageDomain.MEMBER_NAME}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <div class="pic">
                                                    <a href="#"><img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/upload/notices_data/${model.pageDomain.IMAGE}" alt="${model.pageDomain.IMAGE}"></a>
                                                </div>
                                            </td>
                                        </tr>
                                        </c:if>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <div id="fileDiv_${status.index}">
                                                    <a class="pro_file_btn" href="${pageContext.request.contextPath}/fileDown.do?path=${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/upload/notices_data/${item.FILE_PATH}">${fn:substring(item.FILE_NAME,13,fn:length(item.FILE_NAME))}</a>
