                ...
                <div class="sub_size">
                    ...
                    <nav class="right_nav_wrap">
                        ...
                        <ul class="right_nav_area">
                            ...
                            <c:if test="${fn:indexOf(requestURI, '/user/notices_data/4/') > -1}">
                            <li>
                                <a href="${pageContext.request.contextPath}/user/program/100/list.do">문화체험 <span><img src="${pageContext.request.contextPath}/resources/img/sub/down_arrow.png" alt="화살표"></span></a>
                            </li>
                            </c:if>
                        ...
                        <ul>
                            ...
                            || fn:indexOf(requestURI, '/user/notices_data/12/') > -1
                            || fn:indexOf(requestURI, '/user/notices_data/11/') > -1
                            || fn:indexOf(requestURI, '/user/notices_data/3/') > -1}"><li>
                                            ...
                                            <div class="member_input_wrap">
                                                <ul class="member_input">
                                                    ...
                                                    <li>
                                                        ...
                                                        <input class="input_checkbox" type="checkbox" value="3" id="TYPE" name="TYPE">
