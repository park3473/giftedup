...
<c:set var="intMonth"><fmt:formatNumber value="${sysMonth }"></fmt:formatNumber></c:set>
<body>
	                                            ...
	                                            <div class="port_stat_con">
	                                            	...
	                                            	<p>
	                                            		<c:forEach var="i" begin="2020" end="${model.MatchingLastYear }">
	                                            			<span style="margin-right:10px"><button onclick="location.href='${pageContext.request.contextPath}/user/portfolio/detail/list.do?YEAR=${i}'">${i}년도 포트폴리오</button></span>
	                                            		</c:forEach>
	                                            	</p>
	                                            	</c:if>
	                                            	</c:if>
            ...
            <img src="${pageContext.request.contextPath}/resources/img/end_arrow.png" alt="맨끝">
                                ...
                                <!--페이지 넘버 end-->  
                                        ...
                                        <div class="board_btn_wrap">
                                            <div class="board_btn">
                                            	<c:if test="${ssion_member_type == '1'}">
                                            	<c:if test="${sysYear == model.MatchingYear || (sysYear > model.MatchingYear && intMonth < 02) }">
