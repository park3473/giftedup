                                    ...
                                    <div class="member_input_wrap">
				                        <ul class="member_input">
				                            <li>
				                                ...
				                                <input class="input_size7" type="text" NAME="TITLE" ID="TITLE" value="${model.pageDomain.TITLE}">
				                            </li>
				                            <li>
				                                <span class="list_t">간략설명</span>
				                                <input class="input_size7" type="text" NAME="CONTENT" ID="CONTENT" value="${model.pageDomain.CONTENT}">
				                            </li>
