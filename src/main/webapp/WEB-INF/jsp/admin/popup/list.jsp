                                ...
                                <table>
                                    ...
                                    <tr>
                                       ...
                                       <%--  <td>${item.WIDTH} X ${item.HEIGHT}</td>
                                        <td>${item.POINT_X} / ${item.POINT_Y}</td>
                                        <td>
	                                        <c:if test="${item.TYPE == '1'}">레이어</c:if>
	                                        <c:if test="${item.TYPE != '1'}">팝업</c:if>
                                        </td> --%>
                                        <td>
	                                        <c:if test="${item.USEKEY == '1'}">출력</c:if>
	                                        <c:if test="${item.USEKEY != '1'}">출력안함</c:if>
                                        </td>
                                        <td class="delete_list_btn modify_bdlist_btn">
