                                    ...
                                    <div class="member_input_wrap">
                                        <ul class="member_input">
                                            <li>
                                                ...
                                                <input type="text" value="${CheckYear }" name="YEAR" id="YEAR" readonly="readonly">
                                            </li>
                                            <!--
                                            2022년도 고도화시 필요없다고 느낌
                                            <li>
                                            ...
                                            <li>
	                                            <span class="list_t">멘토교사</span>
	                                            <input type="hidden" placeholder="아이디입력" id="MEMBER_ID" name="MEMBER_ID" value="${model.LOCAL_GROUP_IDX}">
	                                            <!-- 
	                                            ...
	                                            <span class="relate_c">직접 아이디를 입력하거나 성명을 검색해주세요.</span>
	                                        	 -->
	                                        	<input class="input_size" type="text" name="PROFESSOR_MEMBER_ID" id="PROFESSOR_MEMBER_ID">
	                                        </li>
...
function memberCheck()
{
	...
	var memberName = $("input[name=member2]:checked").attr('member_name');
	 ...
	 $('[name=PROFESSOR_MEMBER_ID]').val(memberName);
...
function selectAjax()
{
	$.ajax({
		type : "GET",
		url : "./"+$('#MEMBER_ID').val()+'/insertAjax.do?&YEAR='+$('#YEAR').val(),
		cache : false,
		data : "",
