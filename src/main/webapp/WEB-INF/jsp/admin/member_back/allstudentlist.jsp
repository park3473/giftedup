                                        ...
                                        <form>
                                            <div class="form_01">
                                                <div class="page_seach">
                                                    ...
                                                    <select id="EXP_DATA" name="EXP_DATA" >
                                                    	<option value="">학년도</option>
                                                    	<c:forEach var="i" begin="2020" end="2022" >
                                                    		<option value="${i }" <c:if test="${model.beforeDomain.EXP_DATA == fn:substring(i,2,4) }">selected</c:if> >${i }</option>
                                                    	</c:forEach>
                                                    </select>
                                                    ...
                                                    <select ID="SEARCH_TYPE" NAME="SEARCH_TYPE">
                                                        ...
                                                        <option value="MEMBER_ID" <c:if test="${model.beforeDomain.MEMBER_ID == 'MEMBER_ID'}">selected</c:if>>학생아이디</option>
