	...
	jQuery(function() {
	  ...
	  //CKEDITOR.config.contentsCss = '${pageContext.request.contextPath}/resources/css/startupTemplate.css';
  			 ...
  			 <div class="modal-header">
                <h5 class="modal-title" id="smallmodalLabel">수정</h5>
            ...
            <div class="modal-body" >
             ...
             <p>
               		<form:form action="./updateAccess.do?page=${model.page}&search=${model.search}"
             	   ...
             	   <table id="bootstrap-data-table" class="table table-striped table-bordered">
                	  ...
                	  <input type="hidden" NAME="USE_KEY" id="USE_KEY" value='${model.USE_KEY}' />
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-secondary" onClick="deleteAccessClicked();">삭제</button>
                <button type="button" class="btn btn-primary" onClick="updateAccessClicked();">수정</button>
            </div>
