package egovframework.kaist.user.survey_questionnaire.model;
...
public class UserSurveyQuestionnaireVo extends SearchVo{
	...
	List<UserSurveyQuestionnaireVo> list = new ArrayList();
	...
	public List<UserSurveyQuestionnaireVo> getList() {
		return list;
	}
	public void setList(List<UserSurveyQuestionnaireVo> list) {
		this.list = list;
	}
