package egovframework.kaist.user.survey_answer.model;
...
public class UserSurveyAnswerVo extends SearchVo{
	...
	String CREATE_TM; 
	String SURVEY_TEXT = "";
	List<UserSurveyAnswerVo> list = new ArrayList();
	...
	public List<UserSurveyAnswerVo> getList() {
		return list;
	}
	public void setList(List<UserSurveyAnswerVo> list) {
		this.list = list;
	}
