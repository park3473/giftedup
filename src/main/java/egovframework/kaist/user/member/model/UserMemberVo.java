package egovframework.kaist.user.member.model;
...
public class UserMemberVo extends SearchVo {
	...
	String PROF_SCHOOL_NAME = "";
	String PROF_EMAIL = "";
	String PROF_PHONE = "";
	String COMM_DATA = "";
	String COMM_TYPE = "";
	String INFO_UPDATE_TM = "";
	...
	public String getPROF_SCHOOL_NAME() {
		return PROF_SCHOOL_NAME;
	}
	public void setPROF_SCHOOL_NAME(String pROF_SCHOOL_NAME) {
		PROF_SCHOOL_NAME = pROF_SCHOOL_NAME;
	}
	...
	public String getINFO_UPDATE_TM() {
		return INFO_UPDATE_TM;
	}
	public void setINFO_UPDATE_TM(String iNFO_UPDATE_TM) {
		INFO_UPDATE_TM = iNFO_UPDATE_TM;
	}
