...
public class AcceptLogInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		UserAcceptLogVo userAcceptLogVo = new UserAcceptLogVo();
		userAcceptLogVo.setMETHOD(request.getMethod());
		...
		userAcceptLogVo.setMEMBER_ID(ssion_user_id);
		...
		userAcceptLogVo.setIP(ip);
		
		userAcceptLogVo.setURL(request.getRequestURI());
		...
		userAcceptLogVo.setPARAMETER(parm);
		...
		userAcceptLogVo.setDEVICE(browser);
		userAcceptLogService.setInsert(userAcceptLogVo);
