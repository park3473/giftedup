...
public class AdminSmsLogServiceImpl implements AdminSmsLogService {
	...
	public String smsSend(AdminSmsLogVo adminSmsLogVo) throws IOException, NoSuchAlgorithmException {
		...
		String parm_sphone1 = "042"; //보내는번호1
		String parm_sphone2 = "350"; //보내는번호2
		String parm_sphone3 = "6223";//보내는번호3
		
		//예약 여부 확인 date
		String parm_rdate = "";
		if(adminSmsLogVo.getRESERVATION_DT() != null && adminSmsLogVo.getRESERVATION_DT() != "") {
		...
		String parm_rtime = "";
		//예약여부 확인 time
		if(adminSmsLogVo.getRESERVATION_TM() != null && adminSmsLogVo.getRESERVATION_TM() != "") {
